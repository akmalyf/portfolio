...
const Projects = () => {
    ...
    return (
        <section className="container w-full py-24">
            <StickyScrolling className="mx-auto hidden max-w-md lg:min-h-[var(--stick-items)] lg:max-w-none">
                <div className="space-y-16 lg:sticky lg:top-0 lg:h-screen lg:space-y-0">
                    {sections.map((section, index) => (
                        ...
                        >
                            <div
                                className="flex flex-col space-y-4 space-y-reverse lg:h-full lg:flex-row lg:space-x-20 lg:space-y-0">
                                <div
                                    className="order-1 flex flex-1 items-center transition-opacity duration-300 lg:order-none lg:opacity-[var(--stick-visibility)]">
                                    <div className="space-y-3">
                                        <div className="relative inline-flex font-semibold text-blue-500">
                                            {section.label}
                                            <svg
                                                className="absolute top-full w-full fill-blue-500"
                                ...
                                <div
                                    className="flex flex-1 items-center transition duration-300 lg:scale-[var(--stick-scale)] lg:opacity-[var(--stick-visibility)]">
                                    <Image
                                        width="512"
                                        height="480"
                                        src={section.img}
