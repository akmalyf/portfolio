...
const Projects = () => {
    ...
    return (
        <>
            <main className='relative flex min-h-screen flex-col justify-center overflow-hidden bg-zinc-950 supports-[overflow:clip]:overflow-clip'>
                            ...
                            {sections.map((section, index) => (
                                ...
                                >
                                    <div className='flex flex-col space-y-4 space-y-reverse lg:h-full lg:flex-row lg:space-x-20 lg:space-y-0'>
                                        ...
                                        <div className='flex flex-1 items-center transition duration-300 lg:scale-[var(--stick-scale)] lg:opacity-[var(--stick-visibility)]'>
                                            <Image
                                                width='512'
                                                height='480'
                                                src={section.img}
