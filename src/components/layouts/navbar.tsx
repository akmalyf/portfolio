...
const Navbar = () => {
    return (
        <header className="fixed z-40 w-full">
            <div className="container flex h-14 w-full items-center justify-between gap-3 rounded-full border border-zinc-800 bg-zinc-950/70 backdrop-blur-sm px-3 shadow-lg shadow-zinc-400/[0.08] mt-4">
        ...
        <header className='fixed z-40 w-full bg-zinc-950/70 backdrop-blur-sm'>
            <div className='container mx-auto flex max-w-6xl items-center justify-between py-8'>
                ...
                <div className='flex space-x-4'>
                    ...
                    <Link href='/about'>
                        <span className='hover:text-gray-400'>My Work</span>
                    </Link>
                    <Link href='/contact'>
                        <span className='hover:text-gray-400'>Skill</span>
                    </Link>
                    <Link href='/contact'>
